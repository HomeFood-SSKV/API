				...
				using (var dbContextScope = _dbContextScopeFactory.Create())
				{
				  ...
				  MAS_Price MAS_Priceitem=Mapper.Map<MAS_PriceDto ,MAS_Price>(customObject);
  			       return await PersistSvr<MAS_Price>.Update( MAS_Priceitem, commit,(DbContext)context); 
		  			...
		  			public Task<List<MAS_RightsDto>> GetMASRights(object objContext,CancellationToken ct = default(CancellationToken))
			{  
		        using (var dbContextScope = _dbContextScopeFactory.Create())
				{
				  var context = dbContextScope.DbContexts.Get<ConfigurationTrackerEntities>();
			   	  var MAS_RightsRecord= PersistSvr<MAS_Rights>.GetAll(context).Where(i=>i.Status==true).ToList( ); 
				  return Mapper.Map<List<MAS_Rights>, List<MAS_RightsDto>>(MAS_RightsRecord);				 
				 }
			}

			public async Task<int> InsertMASRights( MAS_RightsDto  customObject, bool commit,object objContext,CancellationToken ct = default(CancellationToken)) 
			{ 
		        using (var dbContextScope = _dbContextScopeFactory.Create())
				{
				  var context = dbContextScope.DbContexts.Get<ConfigurationTrackerEntities>();
				 MAS_Rights MAS_Rightsitem=Mapper.Map<MAS_RightsDto ,MAS_Rights>(customObject);
			      if (await PersistSvr<MAS_Rights>.Insert( MAS_Rightsitem, commit,context))
                        return MAS_Rights.MASRightsId;
                    else
                        return 0;
				 }
			}	 

			public async Task<bool> UpdateMASRights( MAS_RightsDto  customObject, bool commit,object objContext,CancellationToken ct = default(CancellationToken)) 
			{ 
				using (var dbContextScope = _dbContextScopeFactory.Create())
				{
				  var context = dbContextScope.DbContexts.Get<ConfigurationTrackerEntities>();
				  MAS_Rights MAS_Rightsitem=Mapper.Map<MAS_RightsDto ,MAS_Rights>(customObject);
  			       return await PersistSvr<MAS_Rights>.Update( MAS_Rightsitem, commit,(DbContext)context); 
				}
			}	 
				...
				using (var dbContextScope = _dbContextScopeFactory.Create())
				{
				  ...
				  MAS_Role MAS_Roleitem=Mapper.Map<MAS_RoleDto ,MAS_Role>(customObject);
  			       return await PersistSvr<MAS_Role>.Update( MAS_Roleitem, commit,(DbContext)context); 
		  			...
		  			public Task<List<ObserveDto>> GetObserve(object objContext,CancellationToken ct = default(CancellationToken))
			{  
		        using (var dbContextScope = _dbContextScopeFactory.Create())
				{
				  var context = dbContextScope.DbContexts.Get<ConfigurationTrackerEntities>();
			   	  var ObserveRecord= PersistSvr<Observe>.GetAll(context).Where(i=>i.Status==true).ToList( ); 
				  return Mapper.Map<List<Observe>, List<ObserveDto>>(ObserveRecord);				 
				 }
			}

			public async Task<int> InsertObserve( ObserveDto  customObject, bool commit,object objContext,CancellationToken ct = default(CancellationToken)) 
			{ 
		        using (var dbContextScope = _dbContextScopeFactory.Create())
				{
				  var context = dbContextScope.DbContexts.Get<ConfigurationTrackerEntities>();
				 Observe Observeitem=Mapper.Map<ObserveDto ,Observe>(customObject);
			      if (await PersistSvr<Observe>.Insert( Observeitem, commit,context))
                        return Observe.ObserveId;
                    else
                        return 0;
				 }
			}	 

			public async Task<bool> UpdateObserve( ObserveDto  customObject, bool commit,object objContext,CancellationToken ct = default(CancellationToken)) 
			{ 
				using (var dbContextScope = _dbContextScopeFactory.Create())
				{
				  var context = dbContextScope.DbContexts.Get<ConfigurationTrackerEntities>();
				  Observe Observeitem=Mapper.Map<ObserveDto ,Observe>(customObject);
  			       return await PersistSvr<Observe>.Update( Observeitem, commit,(DbContext)context); 
				}
			}	 
				...
				using (var dbContextScope = _dbContextScopeFactory.Create())
				{
				  ...
				  TRN_DeliveryDetails TRN_DeliveryDetailsitem=Mapper.Map<TRN_DeliveryDetailsDto ,TRN_DeliveryDetails>(customObject);
  			       return await PersistSvr<TRN_DeliveryDetails>.Update( TRN_DeliveryDetailsitem, commit,(DbContext)context); 
		  			...
		  			public Task<List<TRN_GroupRightsDto>> GetTRNGroupRights(object objContext,CancellationToken ct = default(CancellationToken))
			{  
		        using (var dbContextScope = _dbContextScopeFactory.Create())
				{
				  var context = dbContextScope.DbContexts.Get<ConfigurationTrackerEntities>();
			   	  var TRN_GroupRightsRecord= PersistSvr<TRN_GroupRights>.GetAll(context).Where(i=>i.Status==true).ToList( ); 
				  return Mapper.Map<List<TRN_GroupRights>, List<TRN_GroupRightsDto>>(TRN_GroupRightsRecord);				 
				 }
			}

			public async Task<int> InsertTRNGroupRights( TRN_GroupRightsDto  customObject, bool commit,object objContext,CancellationToken ct = default(CancellationToken)) 
			{ 
		        using (var dbContextScope = _dbContextScopeFactory.Create())
				{
				  var context = dbContextScope.DbContexts.Get<ConfigurationTrackerEntities>();
				 TRN_GroupRights TRN_GroupRightsitem=Mapper.Map<TRN_GroupRightsDto ,TRN_GroupRights>(customObject);
			      if (await PersistSvr<TRN_GroupRights>.Insert( TRN_GroupRightsitem, commit,context))
                        return TRN_GroupRights.TRNGroupRightsId;
                    else
                        return 0;
				 }
			}	 

			public async Task<bool> UpdateTRNGroupRights( TRN_GroupRightsDto  customObject, bool commit,object objContext,CancellationToken ct = default(CancellationToken)) 
			{ 
				using (var dbContextScope = _dbContextScopeFactory.Create())
				{
				  var context = dbContextScope.DbContexts.Get<ConfigurationTrackerEntities>();
				...
				using (var dbContextScope = _dbContextScopeFactory.Create())
				{
				  ...
				  TRN_UserDetail TRN_UserDetailitem=Mapper.Map<TRN_UserDetailDto ,TRN_UserDetail>(customObject);
  			       return await PersistSvr<TRN_UserDetail>.Update( TRN_UserDetailitem, commit,(DbContext)context); 
		  			...
		  			public Task<List<TRN_UserPasswordDto>> GetTRNUserPassword(object objContext,CancellationToken ct = default(CancellationToken))
			{  
		        using (var dbContextScope = _dbContextScopeFactory.Create())
				{
				  var context = dbContextScope.DbContexts.Get<ConfigurationTrackerEntities>();
			   	  var TRN_UserPasswordRecord= PersistSvr<TRN_UserPassword>.GetAll(context).Where(i=>i.Status==true).ToList( ); 
				  return Mapper.Map<List<TRN_UserPassword>, List<TRN_UserPasswordDto>>(TRN_UserPasswordRecord);				 
				 }
			}

			public async Task<int> InsertTRNUserPassword( TRN_UserPasswordDto  customObject, bool commit,object objContext,CancellationToken ct = default(CancellationToken)) 
			{ 
		        using (var dbContextScope = _dbContextScopeFactory.Create())
				{
				  var context = dbContextScope.DbContexts.Get<ConfigurationTrackerEntities>();
				 TRN_UserPassword TRN_UserPassworditem=Mapper.Map<TRN_UserPasswordDto ,TRN_UserPassword>(customObject);
			      if (await PersistSvr<TRN_UserPassword>.Insert( TRN_UserPassworditem, commit,context))
                        return TRN_UserPassword.TRNUserPasswordId;
                    else
                        return 0;
				 }
			}	 

			public async Task<bool> UpdateTRNUserPassword( TRN_UserPasswordDto  customObject, bool commit,object objContext,CancellationToken ct = default(CancellationToken)) 
			{ 
				using (var dbContextScope = _dbContextScopeFactory.Create())
				{
				  var context = dbContextScope.DbContexts.Get<ConfigurationTrackerEntities>();
				  TRN_UserPassword TRN_UserPassworditem=Mapper.Map<TRN_UserPasswordDto ,TRN_UserPassword>(customObject);
  			       return await PersistSvr<TRN_UserPassword>.Update( TRN_UserPassworditem, commit,(DbContext)context); 
		  			...
		  			public Task<List<TRN_UserRightsDto>> GetTRNUserRights(object objContext,CancellationToken ct = default(CancellationToken))
			{  
		        using (var dbContextScope = _dbContextScopeFactory.Create())
				{
				  var context = dbContextScope.DbContexts.Get<ConfigurationTrackerEntities>();
			   	  var TRN_UserRightsRecord= PersistSvr<TRN_UserRights>.GetAll(context).Where(i=>i.Status==true).ToList( ); 
				  return Mapper.Map<List<TRN_UserRights>, List<TRN_UserRightsDto>>(TRN_UserRightsRecord);				 
				 }
			}

			public async Task<int> InsertTRNUserRights( TRN_UserRightsDto  customObject, bool commit,object objContext,CancellationToken ct = default(CancellationToken)) 
			{ 
		        using (var dbContextScope = _dbContextScopeFactory.Create())
				{
				  var context = dbContextScope.DbContexts.Get<ConfigurationTrackerEntities>();
				 TRN_UserRights TRN_UserRightsitem=Mapper.Map<TRN_UserRightsDto ,TRN_UserRights>(customObject);
			      if (await PersistSvr<TRN_UserRights>.Insert( TRN_UserRightsitem, commit,context))
                        return TRN_UserRights.TRNUserRightsId;
                    else
                        return 0;
				 }
			}	 

			public async Task<bool> UpdateTRNUserRights( TRN_UserRightsDto  customObject, bool commit,object objContext,CancellationToken ct = default(CancellationToken)) 
			{ 
				using (var dbContextScope = _dbContextScopeFactory.Create())
				{
				  var context = dbContextScope.DbContexts.Get<ConfigurationTrackerEntities>();
